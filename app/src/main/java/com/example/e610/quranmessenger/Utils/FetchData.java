...
public class FetchData extends AsyncTask<Void,Void,String> {
    ...
    private final static String BasicUrl = "http://api.alquran.cloud/page/";
    private final static String RestOfBasicUrl = "/quran-uthmani";
    private String pageNum;


    public FetchData( String pageNum ) {
    ...
    protected String doInBackground(Void... voids) {
        String JsonData = "";
        try {
            JsonData = Fetching_Data(BasicUrl+pageNum+RestOfBasicUrl);
